...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_FormComponent__ = __webpack_require__(2);
...
class App {
    ...
    init() {
        let component = new __WEBPACK_IMPORTED_MODULE_0__components_FormComponent__["a" /* default */]();
        component.checkFile();
...
class FormComponent {
    constructor() {
        ...
        this.preview = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#previewing');
    }

    checkFile() {
        let $photoInput = __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#photo");
        ...
        $photoInput.change(function () {
            ...
            if (file) {
                ...
                if ($photoInput.next('.error-wrap').find('.error')) {
                    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this.preview).attr('src', 'assets/img/no-img.jpg');
    ...
    formHandler() {
        ...
        this.$form.submit(function (event) {
            ...
            __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.ajax({
                ...
                processData: false,
                success: data => {
                    let parsedData = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.parseJSON(data);
                    _this.$form.find('.error').remove();

                    if (parsedData.status) {
                        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.new-book-section_form').remove();
                        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.new-book-section_info h3').innerText = 'Book has been upload successfully';
                    } else {
